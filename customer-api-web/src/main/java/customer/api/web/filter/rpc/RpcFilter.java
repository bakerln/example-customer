package customer.api.web.filter.rpc;
 ...
 * 1: 不允许方法重载
 * 2:参数注解支持 @RequestParam、@RequestBody
 * </p>
 *
 * @author linan
 * @date 2021-06-03
...
@Order(-1)
@Component
@ConditionalOnProperty(value = "rpc.filter",havingValue = "true",matchIfMissing = true)
public class RpcFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try{
            ...
            Method targetMethod = methodMap.get(serviceNameAndMethod[2]);
            ...
            if (targetMethod == null) {
                ...
                if (serviceBean == null) {
                    ...
                    printWriter.write(JsonUtil.toJsonStr(ResultWrapperUtil.serverError("没有找到class=" + serviceNameAndMethod[0])));
                    return;
                }
                ...
                methodMap.put(serviceNameAndMethod[2], targetMethod);
            }
            ...
            if (parameterMap.size() == 0){
                ...
                try {
                    ...
                    bodyParam = writer.getBuffer().toString();
                } finally {
                    writer.close();
                }
            }
...
//                        List list = JsonUtil.toList(bodyStr, paramClassType.getComponentType());
//                        //创建一个数组
...
//                            printWriter.write(JsonUtil.toJsonStr(ResultWrapperUtil.serverError("不支持的数组类型:" + paramClassType.getComponentType())));
//                            return;
//                        }
//                        //创建一个数组
...
//                        printWriter.write(JsonUtil.toJsonStr(ResultWrapperUtil.serverError("List类型参数没有指定泛型类型:" + serviceNameAndMethod[0] + "." + serviceNameAndMethod[1])));
//                        return;
//                    }
